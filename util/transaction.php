...
class transaction implements NekoniumType
{
    ...
    public static function fromASSOC($assoc)
    {
        return new transaction(
            ...
            data::fromHexNullable($assoc['blockHash']),
            quantity::fromHexNullable($assoc['blockNumber']),
            quantity::fromHexNullable($assoc['transactionIndex']),
            data::fromHex($assoc['from']),
            data::fromHexNullable($assoc['to']),
